...
class GenericsTest {
    ...
    fun `copyWith with no changes returns an equal object`() {
        val initial = GenericClass(valueT = Base(integer = 1), valueU = "aaa")
    ...
    fun `copyWith changes the value field`() {
        ...
        result shouldBe GenericClass(valueT = Base(integer = 2), valueU = "aaa")
    }
    ...
    fun `copyWith sets nullable field to null`() {
        ...
        result shouldBe GenericClass(valueT = Base(integer = 1), valueU = null)
    }
}
